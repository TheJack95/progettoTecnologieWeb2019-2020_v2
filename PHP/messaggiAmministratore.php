<?php
    ...
    $output = str_replace('<a href="../PHP/messaggiAmministratore.php">MESSAGGI</a>','<img class="iconaMenu" src="../Images/auto.svg" alt="icona del men&ugrave; che ritrae una automobilina" />MESSAGGI',$output);

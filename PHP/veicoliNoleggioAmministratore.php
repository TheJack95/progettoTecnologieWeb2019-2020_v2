<?php
    ...
    $output = str_replace('<a href="../PHP/veicoliNoleggioAmministratore.php">VEICOLI A NOLEGGIO</a>','<img class="iconaMenu" src="../Images/auto.svg" alt="icona del men&ugrave; che ritrae una automobilina" />VEICOLI A NOLEGGIO',$output);

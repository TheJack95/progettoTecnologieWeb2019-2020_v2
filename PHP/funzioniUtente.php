    ...
    public function getDati(){
        ...
        if(mysqli_num_rows($queryResult)==0){
          ...
          $contentItems.="<div class='dati'>"."\n"
                        ."	<div>"."\n"
                        ."		<div>"."\n"
                        ."			<span>Nome&colon;</span>"."\n"
                        ."			<span id='nome'>".$row['Nome']."</span>"."\n"
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<span>Cognome&colon;</span>"."\n"
                        ."			<span id='cognome'>".$row['Cognome']."</span>"."\n"
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<span>Data di nascita&colon;</span>"."\n"
                        ."			<span id='data'>".$row['DataNascita']."</span>"."\n"
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<span>E-mail&colon;</span>"."\n"
                        ."			<span id='email'>".$row['Email']."</span>"."\n"
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<span>Numero di telefono&colon;</span>"."\n"
                        ."			<span id='telefono'>".$row['Telefono']."</span>"."\n"
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<span>Indirizzo&colon;</span>"."\n"
    ...
    public function setDati(){
        ...
        if(mysqli_num_rows($queryResult)==0){
          ...
          $contentItems.="<div class='dati'>"."\n"
                        ...
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<label for='nome'>Nuovo nome&colon;</label>"."\n"
                        ...
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<label for='cognome'>Nuovo cognome&colon;</label>"."\n"
                        ...
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<label for='nascita'>Nuova data di nascita&colon;</label>"."\n"
                        ...
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<label for='telefono'>Nuovo numero di telefono&colon;</label>"."\n"
                        ...
                        ."		</div>"."\n"
                        ."		<div>"."\n"
                        ."			<label for='indirizzo'>Nuovo indirizzo&colon;</label>"."\n"

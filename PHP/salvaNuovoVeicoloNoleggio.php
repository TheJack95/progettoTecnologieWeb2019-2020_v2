<?php
    ...
    if(isset($_SESSION["admin"]) && $_SESSION["admin"] == 1) {
        ...
        if ($connessioneDatabase->esegui($insert) == TRUE) {
            ...
            $messaggio = "<p class='messaggio successMessage'>Nuovo veicolo a noleggio inserito correttamente&period; Potresti non vedere subito il veicolo appena inserito&comma; eventualmente ricarica la pagina&period;</p>";

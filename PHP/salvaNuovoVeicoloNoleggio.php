<?php
    ...
    if(isset($_SESSION["admin"]) && $_SESSION["admin"] == 1) {
        ...
        if(controlloInput::validTarga($_POST["targa"])) {
            ...
            $valid = false;
            $errori .= "<p class='messaggio errorMessage'>La targa inserita non &egrave; valida&colon; ricorda che non pu&ograve; essere vuota e deve avere sette caratteri&period;</p>";
        }
        ...
        if(controlloInput::validNumeri($_POST["cauzione"])) {
            ...
            $valid = false;
            $errori .= "<p class='messaggio errorMessage'>La cauzione inserita non &egrave; valida&colon; ricorda che non pu&ograve; essere vuota e deve contenere solo numeri&period;</p>";
        }
        ...
        if($valid == true) {
            ...
            if ($connessioneDatabase->esegui($insert) == TRUE) {
                ...
                $messaggio = "<p class='messaggio errorMessage'>Non &egrave; possibile inserire il nuovo veicolo a noleggio per un problema del database&period; Riprova&period;</p>";
                $_SESSION["nuovoMessaggio"] = $messaggio;

\section{Analisi}
    ...
    \subsection{Casi d'uso}
        ...
        L’utente generico accede alla pagina Contatti cliccando la sezione Contatti presente nella navbar, essa è l'unica pagina che è stata dichiarata come HTML 5 nel sito dato che al suo interno si trova una mappa importata da google maps. La pagina offre informazioni e servizi utili all’utente come:
        \begin{itemize}

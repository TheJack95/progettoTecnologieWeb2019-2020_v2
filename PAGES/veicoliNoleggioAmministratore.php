    ...
    if(isset($_SESSION["admin"]) && $_SESSION["admin"] == 1) {
        ...
        foreach($request as $response) {
            $veicoliN .= "<div class='divAmm'>"."\n"
                        ...
                        ."          <fieldset>"."\n"
                        ."              <legend>Modifica veicolo</legend>"."\n"
        ...
        if(count($request) == 0) {
            $veicoliN .= "<p class='msgAmm'>Al momento non sono disponibili veicoli a noleggio&#46;</p>";
        }
        ...
        $output = str_replace('<a href="veicoliNoleggioAmministratore.php" tabindex="10">Lista veicoli a noleggio</a>','&#62; Lista veicoli a noleggio',$output);
        echo $output;
    } else {

...
$filtri ='<div>'."\n"
		...
		.'  	<fieldset>'."\n"
		.'				<label for="searchbar">Ricerca auto</label>'."\n"
		...
		.'				<input type="text" name="dataInizio" tabindex="1" title="datainizionolo"/>'."\n"
		.'				<label for="dataFine">Al</label>'."\n"
		.'				<input type="text" name="dataFine" tabindex="2" title="datafinenolo"/>'."\n"
		.'				<button type="submit" name="applicaFiltri" value="applicaFiltri" class="button internal-button" tabindex="3" title="cerca">Cerca</button>'."\n"
		.'  	</fieldset>'."\n"
		.'	</form>'."\n"
		.'</div>';

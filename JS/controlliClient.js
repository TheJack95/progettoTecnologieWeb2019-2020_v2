...
regex["nome"] = /^[a-zA-Z ]{3,50}$/;
regex["cognome"] = /^[a-zA-Z ]{3,50}$/;
regex["messaggio"] = /^[a-zA-Z0-9€?$@&#()'!,+\-;:=_.\s]{20,}$/;
regex["numeroTelefono"] = /^([\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6})*$/;
regex["password"] = /^[a-zA-Z0-9]{4,}$/;
...
regex["oggetto"] = /^[a-zA-Z0-9€?$@&#()'!,+\-;:=_.\s]{3,}$/;
regex["marca"] = /^[a-zA-Z0-9€?$@&#()'!,+\-;:=_.\s]{3,}$/;
regex["modello"] = /^[a-zA-Z0-9€?$@&#()'!,+\-;:=_.\s]{3,}$/;
regex["chilometri"] = /^[0-9]{1,}$/;
regex["cilindrata"] = /^[0-9]{3,}$/;
regex["prezzo"] = /^[0-9]{2,}$/;
regex["descrizione"] = /^[a-zA-Z0-9€?$@&#()'!,+\-;:=_.\s]{10,}$/;
regex["targa"] = /^[a-zA-Z]{2}[0-9]{3}[a-zA-Z]{2}$/;
regex["costo"] = /^[0-9]{2,}$/;
regex["cauzione"] = /^[0-9]{2,}$/;
